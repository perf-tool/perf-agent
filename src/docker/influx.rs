...
struct InfluxDockerMemMetrics {
    ...
    usage: u64,
    cache: u64,
    usage_with_cache: u64,
    usage_percent: f64,
    cache_percent: f64,
    usage_with_cache_percent: f64,
    active_anon: u64,
    active_file: u64,
    inactive_anon: u64,
    inactive_file: u64,
    ...
    for docker_metric in docker_metrics {
        ...
        mem_influx.push(
            InfluxDockerMemMetrics {
                ...
                cache: docker_metric.memory_cache_bytes,
                usage_with_cache: docker_metric.memory_usage_bytes + docker_metric.memory_cache_bytes,
                usage_percent: docker_metric.memory_percentage,
                cache_percent: docker_metric.memory_cache_percentage,
                usage_with_cache_percent: docker_metric.memory_percentage + docker_metric.memory_cache_percentage,
